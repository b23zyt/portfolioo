...
Computer Engineering @ University of Waterloo (4.0 CGPA / 94.86%, First in Class) · Exchange student @ TU Delft, Fall 2026 · Seeking a Winter 2027 co-op
...
`b23zeng@uwaterloo.ca` · [LinkedIn](#) · [GitHub](#) · [LeetCode](#) · [ePortfolio](#)
...
`SystemVerilog` `Xilinx Kria` · Jul – Aug 2026
...
`SystemVerilog` `Xilinx Kria` · May – Jun 2026
...
`C` `POSIX IPC` `libcurl` · Sep – Dec 2025
...
`STM32` `C` `PWM` `I2C` `WiFi` `Bluetooth` · Jun – Aug 2025
...
### Smart Home System
`STM32` `C` `ADC` `DMA` `Flash` `MQTT` · May – Jun 2025
...
`VHDL` `Altera Cyclone` · Jun – Jul 2024
